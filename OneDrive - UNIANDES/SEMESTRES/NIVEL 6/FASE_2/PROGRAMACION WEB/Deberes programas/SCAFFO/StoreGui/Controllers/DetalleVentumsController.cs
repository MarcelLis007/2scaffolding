...
namespace StoreGui.Controllers
{
    public class DetalleVentumsController : Controller
    {
        ...
        public DetalleVentumsController(TiendaBebidasDbContext context)
        {
            _context = context;
        }
        ...
        {
            var tiendaBebidasDbContext = _context.DetalleVenta.Include(d => d.Producto).Include(d => d.Venta);
        ...
        public async Task<IActionResult> Create([Bind("DetalleVentaId,VentaId,ProductoId,Cantidad,PrecioUnitario,Subtotal")] DetalleVentum detalleVentum)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DetalleVentaId,VentaId,ProductoId,Cantidad,PrecioUnitario,Subtotal")] DetalleVentum detalleVentum)
        {
