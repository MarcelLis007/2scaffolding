...
namespace StoreGui.Controllers
{
    public class CategoriumsController : Controller
    {
        ...
        public CategoriumsController(TiendaBebidasDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CategoriaId,Nombre,Descripcion,EdadMinima,RequiereId")] Categorium categorium)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoriaId,Nombre,Descripcion,EdadMinima,RequiereId")] Categorium categorium)
        {
